...
CREATE TABLE 
Department (department_id VARCHAR(10) PRIMARY KEY,
...
SELECT emp_id , name, avg(salary) as avg_salary, department_name from employee e
join department d on
e.department_id = d.department_id group by emp_id order by avg_salary desc limit 1;
